...
public class LunarFestival {
    ...
    //特殊年份节气日期偏移
    private final static Map<Integer, Integer[]> INCREASE_OFFSETMAP = new HashMap<>();//+1偏移
    private final static Map<Integer, Integer[]> DECREASE_OFFSETMAP = new HashMap<>();//-1偏移
     ...
     * @param tagDate 目标日期
     */
    public void initLunarCalendarInfo(LocalDate tagDate) {
        //String[] splitDate = currentDate.split("-");
        //设置生肖
        //int year = Integer.parseInt(splitDate[0]);
        int year = tagDate.getYear();
        ...
        try {
            ...
            nowaday = solarDateFormat.parse(tagDate.format(DateTimeFormatter.ISO_LOCAL_DATE));
        ...
        int month = tagDate.getMonthValue();
        //int day=Integer.parseInt(splitDate[2]);
        int day = tagDate.getDayOfMonth();
        ...
        for (String s : solarHoliday) {
            // 返回公历节假日名称
            String sd = s.split(" ")[0]; // 节假日的日期
            String sdv = s.split(" ")[1]; // 节假日的名称
            //String smonth_v = splitDate[1];
            String smonth_v = String.valueOf(tagDate.getMonthValue());
            //String sday_v = splitDate[2];
            String sday_v = String.valueOf(tagDate.getMonthValue());
