...
public final class LunarTool {
    ...
    public LunarTool(LocalDate date) {
     ...
     * 将 int 转成 string
     */
    public static String getChinaDayString(int month, int day) {
        return chineseNumber[month - 1] + "月" + getChinaDayString(day);
    }

    /**
     * @return 将 date 转换为 string
     */
    @NonNull
    public String toString() {
        return (leap ? "闰" : "") +  getChinaDayString(day);
    }
}
